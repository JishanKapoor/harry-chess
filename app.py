...
app = Flask(__name__)
app.config["SECRET_KEY"] = os.environ.get("SECRET_KEY", "wizard_chess_secret")
...
SPELLS = [
    ...
    {"id": "fiendfyre", "name": "Fiendfyre", "rarity": "Rare", "icon": "🔥", "action": "click", "desc": "Click a square to destroy it and surrounding squares."},
    ...
    {"id": "expelliarmus", "name": "Expelliarmus", "rarity": "Common", "icon": "🪄", "action": "instant", "desc": "Keep your move and force another turn."},
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .brand-badge{
            ...
            color:#111;
            box-shadow:0 8px 18px rgba(129,182,76,.2);
        }
        ...
        .board-shell-inner{
            border-radius:14px;
            overflow:hidden;
            box-shadow:0 0 0 1px rgba(255,255,255,.03), 0 16px 40px rgba(0,0,0,.35);
        }
        .board-shell-inner.magic-active{
            box-shadow:0 0 0 1px rgba(168,85,247,.55), 0 0 30px var(--glow), 0 16px 40px rgba(0,0,0,.35);
            cursor:crosshair;
        }
    ...
    <div class="page">
        <div class="layout">
            <div class="board-column">
                ...
                <div class="player-strip bottom">
                    <div class="player-left">
                        ...
                        <div class="player-text">
                            ...
                            <div class="player-sub" id="my-sub">Waiting for game start.</div>
                        </div>
                    </div>
                ...
                <div class="hand-panel">
                    <div class="hand-head">
                        ...
                        <div class="hand-note">6 spells: 1 Legendary, 2 Rare, 3 Common</div>
                    </div>
            ...
            <div class="sidebar">
                <div class="card">
                    <div class="card-head">
                        <div class="card-title">Match Telemetry</div>
                ...
                <div class="card">
                    ...
                    <div class="mini-state" id="mini-state">
                        Share the link above to start a game. When the second player joins, the board unlocks and both hands become live.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-overlay" id="rules-modal">
        <div class="modal">
            ...
            <p>
                ...
                The server enforces whose turn it is. Spells cannot be cast out of turn.
            </p>
            <p>
                Expelliarmus does not end your turn. Time-Turner rewinds to the prior board state.
    ...
    <script>
        ...
        function appendSpell(text) {
            $("#move-history").append(`
                <div class="move-row">
                    <div></div>
                    <div class="move-ply spell-ply">${text}</div>
                </div>
            `);
            const box = $(".card-body")[0];
            if (box) box.scrollTop = box.scrollHeight;
        ...
        function finishTargetedSpell(spell, baseFen, logText) {
            ...
            socket.emit("spell_effect", {
                ...
                fen: game.fen(),
                consume_turn: true,
                log: logText || spell.name.toUpperCase()
            });
        }
        ...
        function onDragStart(source, piece) {
            ...
            if (!myColor || myColor === "s") return false;
        ...
        function onDrop(source, target) {
            ...
            if (!myColor || myColor === "s") return "snapback";
        ...
        window.addEventListener("resize", ensureBoardSize);
        ...
        updateTurnUI();
        updateCapturedPieces();
        setTimeout(() => ensureBoardSize(), 100);
    </script>
</body>
</html>
"""
